...
private:
    ...
    std::vector<sf::Vector2f> RecreatePathPoints(std::unordered_map<NavPoly*, NavPoly*> CameFrom, NavPoly* current, const sf::Vector2f& startPos, const sf::Vector2f& targetPos);
	std::vector<NavPoly*> RecreatePathNavPolys(std::unordered_map<NavPoly*, NavPoly*> CameFrom, NavPoly* current, const sf::Vector2f& startPos, const sf::Vector2f& targetPos);
	std::vector<sf::Vector2f> OptimizePathFunnel(const std::vector<NavPoly*>& polyPath, const sf::Vector2f& start, const sf::Vector2f& target);
...
struct PriorityQueue {
	...
	inline void add(T item, Number priority) {

...
void DrawDebugLine(const sf::Vector2f& pos, const sf::Vector2f& dir, const float& norm, sf::RenderTarget& target, const sf::Color& colour = sf::Color::Yellow);
...
const sf::Vector2f CalcIntersectionPoint(const sf::Vector2f& a1, const sf::Vector2f& b1, const sf::Vector2f& a2, const sf::Vector2f& b2);
